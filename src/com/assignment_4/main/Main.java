...
public class Main {
	...
	public static void main(String[] args) {
		...
		account = bc.getCustomerAccounts().get(0)
				.getAccountNumber();
		System.out.println(
		...
		System.out.println(
				"Withdrawing 200.0 from the second account");
		account = bc.getCustomerAccounts().get(1)
				.getAccountNumber();
		bc.withdrawFromAccount(account, 200);
		System.out.println(bc.toString());

		System.out.println(
				"Depositing 200 to the third account");
		account = bc.getCustomerAccounts().get(2)
				.getAccountNumber();
